...
public:
    ...
    /**
     * @brief Create the headers of the results table
     */
    void InitResultsTable();

    /**
     * @brief Add one round worth of information to the results table
     */
...
private:
    ...
    /** 
     * @brief string for storing information to be displayed in the results table
     */
    std::string results_table_ir;

    /**
     * @brief Tracking counter for the number of processing rounds
     */
    int round_number;
};
