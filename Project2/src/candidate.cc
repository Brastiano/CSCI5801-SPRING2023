...
int Candidate::GetPrevVoteCount()
{
    // Get the number of votes that this candidate had during the previous round
    return n_votes_prev_round;
}

void Candidate::SetPrevVoteCount()
{
    n_votes_prev_round = n_votes;
}
